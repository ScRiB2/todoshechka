import * as css from "../ErrorBoundary/ErrorBoundary.css";
import * as React from "react";

const BigErrorHandler = ({errorText}: {errorText: string}) => (
    <>
        ...
        <div className={css.h1}>{errorText}</div>
    </>
);

export default BigErrorHandler